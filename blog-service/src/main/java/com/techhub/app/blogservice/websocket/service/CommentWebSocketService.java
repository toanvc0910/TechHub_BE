package com.techhub.app.blogservice.websocket.service;
...
/**
 * Service để gửi WebSocket messages cho comments.
 * Được sử dụng bởi các REST controllers hoặc services khác 
 * khi cần broadcast comment updates.
 */
@Slf4j
@Service
...
public class CommentWebSocketService {
    ...
    private String getDestination(CommentTargetType targetType, UUID targetId) {
        return "/topic/blog/" + targetId + "/comments";
    }
}
