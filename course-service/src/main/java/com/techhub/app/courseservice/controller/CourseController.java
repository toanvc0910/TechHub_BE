...
public class CourseController {
        ...
        @GetMapping
        public ResponseEntity<PageGlobalResponse<CourseSummaryResponse>> getCourses(
                ...
                return ResponseEntity.ok(
                                PageGlobalResponse
                                                .success("Courses retrieved successfully", coursePage.getContent(),
                                                                paginationInfo)
        ...
        public ResponseEntity<GlobalResponse<LessonResponse>> getLesson(@PathVariable UUID courseId,
                        @PathVariable UUID chapterId,
                        @PathVariable UUID lessonId,
                        HttpServletRequest request) {
                LessonResponse response = courseService.getLesson(courseId, chapterId, lessonId);
                return ResponseEntity.ok(
                                GlobalResponse.success("Lesson retrieved successfully", response)
                                                .withPath(request.getRequestURI()));
        }
        ...
        public ResponseEntity<GlobalResponse<LessonAssetResponse>> updateLessonAsset(@PathVariable UUID courseId,
                        ...
                        @Valid @RequestBody LessonAssetRequest requestBody,
                        HttpServletRequest request) {
                LessonAssetResponse response = courseService.updateLessonAsset(courseId, chapterId, lessonId, assetId,
                                requestBody);
                return ResponseEntity.ok(
